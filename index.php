	...
	<div class="container">
		...
		<form  method="POST" class="form-horizontal" role="form" action="toXML.php">
			<div class="form-group">
				<label for="id_1" class="control-label col-xs-2">Enter Application ID</label>
				<div class="col-xs-6">
			...
			<div class="form-group">
				<label for="list1" class="control-label col-xs-2">Select Relationship</label>
				<div class="col-xs-6">
					<input type="radio" name="list" value="Father" id="list1">&nbsp;&nbsp;Father<br />
					<input type="radio" name="list" value="Mother" id="list2">&nbsp;&nbsp;Mother<br />
					<input type="radio" name="list" value="Husband" id="list3">&nbsp;&nbsp;Husband<br />
				</div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="I_sec2_1a" class="control-label col-xs-2">2. *I am Graduate of the</label>
				<div class="col-xs-6">
			...
			<div class="form-group">
				<label for="I_sec2_2a" class="control-label col-xs-2">*I am in possession of Diploma/certificates in</label>
				<div class="col-xs-6">
					<br /><input type="text" class="form-control" id="I_sec2_2a" name="I_sec2_2a"><br />
			...
			<div class="form-group">
				...
				<div class="col-xs-6">
					<input type="email" class="form-control" id="II_sec7_1" name="II_sec7_1">
				</div>
			</div><br />
			<div class="row right">
